...
resource "aws_security_group" " " {
   name = " "// Para ingresar el nombre del grupo de seguridad(el mismo que ingreso arriba)
ingress  {
...
resource "aws_s3_bucket_object" "object" {
  ...
  source = "C:\\Users\\kevin\\tallerso\\Zona_(A).tf"

  etag = filemd5("C:\\Users\\kevin\\tallerso\\Zona_(A).tf")
